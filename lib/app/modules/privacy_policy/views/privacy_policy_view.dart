...
import 'package:ngabsen/app/modules/privacy_policy/controllers/privacy_policy_controller.dart';
...
class PrivacyPolicyView extends GetView<PrivacyPolicyController> {
  var contentBase64 = base64Encode(const Utf8Encoder().convert('''
    ...
    <body>
        ...
        <ul>
            ...
            <li>
                <p><strong>Application</strong> means the software program provided by the Company downloaded by You on any
                    electronic device, named Ngabsen</p>
            </li>
            <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
                    or
                    &quot;Our&quot; in this Agreement) refers to Ngabsen.</p>
            </li>
            <li>
        ...
        <ul>
            <li>
                <p>By email: kelompok3.papb.a@ngabsen.com</p>
            </li>
            <li>
                <p>By visiting this page on our website: <a href="http://ngabsen.dev/" rel="external nofollow noopener"
                        target="_blank">http://ngabsen.dev/</a></p>
            </li>
        </ul>
